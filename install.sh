...
verificar_dir(){
	if [ -d "$path/src" ] && [ -d "$path/include" ] && [ -f "$path/include/Class_Point.h" ] && [ -f "$path/src/Busca.cpp" ] && [ -f "$path/src/Missao.cpp" ] && [ -f "$path/src/MainApp.cpp" ] && [ -f "$path/src/Telemetria.cpp" ]; then
